...
c     Author: Binbin Zhou, Apr. 7, 2011, based on Jun Du code
c     May 24, 2013, Binbin Zhou: Modified to grib2 I/O
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c  	subroutine get_mxp (nv,ifunit,jpdtn,jf,iens,Lq,mxp8,missing,
c    +wgt,eps) 
   	subroutine get_mxp (nv,ifunit,jpdtn,jf,iens,Lq,mxp8,missing,wgt) 
...
c   for max,min,10,25,50,90% mean products
     ...
     +              qMeanLevel,qMsignal
        ...
        type(gribfield) :: gfld
         ...
         write(*,*) 'In mxp'
         write(*,*)  'nv,ifunit,jf,iens,Lq=',
     +                nv,ifunit,jf,iens,Lq  
         ...
         jd10=qk6(nv)
         jp27=-9999
         write(*,*)  'jpdtn,jd1,jd2,d10,jd27,eps=',
     +                jpdtn,jd1,jd2,d10,jd27,eps
